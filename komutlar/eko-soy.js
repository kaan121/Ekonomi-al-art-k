    ...
    if (weekly !== null && timeout - (Date.now() - weekly) > 0) {
      ...
      if (args[0] === "kuyumcu") {
        ...
        if (weekly !== null && timeout - (Date.now() - weekly) > 0) {
          ...
          if (!uziadet) {
            message.reply(
              "**Yanında `Uzi` olmadığı için kuyumcuyu soyamadın ve 1000 TL paran gitti.**"
            );
          ...
          if (uziadet) {
            ...
            let embed = new Discord.MessageEmbed()
              ...
              .setColor("GREEN")
              .setImage(
                "https://media.indiedb.com/images/groups/1/25/24269/giphy.gif"
              )
              .setTimestamp();
            message.channel.send(embed);
            client.channels.cache
              .get(soygunlog)
              .send(
                `**${message.author.tag}**, Adlı kullanıcı \`Kuyumcu\`'yu soydu ${para}TL kazandı.`
              );
          }
        }
      }
      if (args[0] === "adam") {
        ...
        if (!user)
          return message.reply(`Soymak istediğiniz kişiyi etiketleyin.`);
        ...
        if (!bıçak)
          return message.reply(
            `**${user.tag}** adlı kullanıcıyı soymak için \`Bıçak\` lazım.`
          );
        ...
        if (db.has(`${user.id}.kalkan`) === true) {
          ...
          client.channels.cache
            .get(soygunlog)
            .send(
              `😂 **${message.author.tag}** Adlı kullanıcı **${user.tag}**'ı soycak iken kalkan'a takıldı! ve **${user.tag}** korundu...`
            );
          return message.reply(
            `Maalesef! **${user.tag}** Adlı kullanıcı marketten \`1 Günlük Kalkan\` aldığı için onu soyamazsın! (500TL kaybettiniz)`
          );
        }
        if (db.has(`${user.id}.kalkan`) === false) {
          ...
          client.channels.cache
            .get(soygunlog)
            .send(
              `**${message.author.tag}**, Adlı kullanıcı \`${user.tag}\` Adlı kullanıcıyı soydu ve ${random}TL kazandı.`
            );
        }
      }
      if (args[0] === "market") {
        ...
        if (weekly !== null && timeout - (Date.now() - weekly) > 0) {
          ...
          if (!pistoladet) {
            message.reply(
              "**Yanında `Pistol` olmadığı için marketi soyamadın ve Polis seni kıskıvrak yakaladı ve 1000 TL para cezası kesti.**"
            );
          ...
          if (pistoladet) {
            ...
            let embed = new Discord.MessageEmbed()
              ...
              .setTimestamp()
              .setImage(
                "https://static.wixstatic.com/media/f9f6e8_dfe88e43dc4044ceb8e2775ca3b17b49~mv2.gif/v1/fit/w_2500,h_1330,al_c/f9f6e8_dfe88e43dc4044ceb8e2775ca3b17b49~mv2.gif"
              );
            message.channel.send(embed);
            client.channels.cache
              .get(soygunlog)
              .send(
                `**${message.author.tag}**, Adlı kullanıcı \`Market\`'i soydu ${para}TL kazandı.`
              );
          }
        }
      }
      ...
      if (args[0] === "banka") {
        ...
        if (weekly !== null && timeout - (Date.now() - weekly) > 0) {
          ...
          if (!ak47adet) {
            message.reply(
              "**Yanında `AK-47` olmadığı için marketi soyamadın ve Polis seni kıskıvrak yakaladı ve 1000 TL para cezası kesti.**"
            );
            await db.set(`para_${message.author.id}`, para - 1000);
          }
          if (ak47adet) {
            ...
            client.channels.cache
              .get(soygunlog)
              .send(
                `**${message.author.tag}**, Adlı kullanıcı \`Banka\`'yı soydu ${para}TL kazandı.`
              );
          }
        }
      }
