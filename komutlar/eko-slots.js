...
exports.run = function (client, message, args) {
  ...
  if (!hesapdurumu) {
    const embed = new Discord.MessageEmbed()
      ...
      .setDescription(
        `Bir hesabınız bulunmamakta lütfen hesap açınız. s!hesap-oluştur hesapismi`
      );
    ...
    if (!miktar)
      return message.channel.send(
        new Discord.MessageEmbed()
          ...
          .setColor("GREEN")
          .setDescription(
            `**Slot-Machine** oynamak için miktar girmen gerekiyor!`
          )
      );
    ...
    if (miktar > para)
      return message.channel.send(
        new Discord.MessageEmbed()
          ...
          .setDescription(
            `Slot-Machine oynamak için cüzdanında ${
              para ? "sadece " + para + " 💸 var!" : "hiç paran yok!"
            }`
          )
      );
    ...
    if (miktar < 100)
      return message.channel.send(
        new Discord.MessageEmbed()
          ...
          .setColor("GREEN")
          .setDescription(
            `**Slot-Machine** oynamak için en az 100 💸 yatırabilirsin!`
          )
      );
...
${slots[alt1]} | ${slots[alt2]} | ${slots[alt3]} |`,
          true
        )
        .setColor("GREEN");
      message.channel.send(embed);
