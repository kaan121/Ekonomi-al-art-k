...
exports.run = async (client, message, args) => {
  ...
  if (!hesapdurumu)
    return message.channel.send(`Kayıtlı olan bir kullanıcı belirtmelisin!`);
