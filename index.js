...
//--------------------boru seste tutma-------------------------\\
client.on("ready", () => {
  client.channels.cache.get("933632565754069002").join();
});
//--------------------------------------------------\\

client.ayarlar = {
  prefix: "!",
  sahip: ["811667572135034901"],
};
client.ekoayarlar = {
  parabirimi: "TL", //Para Birimi TL İsterseniz Dolar Euro Vb. Para Birimleri Girebilirsiniz.
  botunuzunprefixi: "!",
  botunuzunidsi: "940356692548407366",
  botismi: "Crazy Of Economy",
  ...
  günlükpara: 250, //EĞER RASTGELE PARAYI TRUE YAPTIYSANIZ BURAYI ELLEMENİZE GEREK YOK!
  ...
  dblkey:
    "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6Ijc4MTE5NDEwODg4NTkyNTk0OCIsImJvdCI6dHJ1ZSwiaWF0IjoxNjEwOTE0MjMzfQ.P_HOXh4kUfqf-bITfJkts3ttdqwgjidz6U1pzgVA7Mk", //EĞER DBLOY U AKTİF ETMEDİYSENİZ BURAYA KEY EKLEMENİZE GEREK YOK EĞER AKTİF ETTİYSENİZ DBL SİTESİNDEN BULABİLİRSİNİZ!
  dblmsj:
    "Bu komutu kullanabilmek için bota oy vermeniz gerekmektedir. Oy vermek için a?oyver", //EĞER DBLOY U AKTİF ETMEDİYSENİZ BURAYA MESAJ YAZMANIZA GEREK YOK! EĞER AKTİF ETTİYSENİZ BOTA OY VERMEK İÇİN HANGİ MESAJI YAZACAĞINI AYARLAYABİLİRSİNİZ.
  başlangıçparası: 500, //EĞER RASTGELE PARAYI TRUE YAPTIYSANIZ BURAYI ELLEMENİZE GEREK YOK!
  admin: ["811667572135034901"], //["id","",""]
  btcdeger: 100000,
};
...
client.on("message", async (message) => {
  let süre = setTimeout(async () => {
    ...
    console.warn(
      `${message.author.tag} (${message.author.id}) adlı kullanıcının soygun sistemi sıfırlandı.`
    );
    clearInterval(süre);
  }, 300000);
});
